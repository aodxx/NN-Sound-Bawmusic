...
โฟลเดอร์หลักของแอดมิน: [ภาพ NN' SOUND MUSIC Creative](https://drive.google.com/drive/folders/1svCT-d1tMbBKudsVKznAAAavzWTrqPPo)

- [Bawmusic Equipment](https://drive.google.com/drive/folders/1-gDNrWtUseZas1vtbR-25Ukm_zoR2sOU) — รูปอุปกรณ์ที่เปิดดูได้ด้วยลิงก์ เพื่อให้ลูกค้าเห็นผ่าน GitHub Pages/LIFF
- [Bawmusic Profile Backup](https://drive.google.com/drive/folders/1lovhpdL0C24sNSFNOCHFQ8KVnQq1oxAw) — สำเนารูปโปรไฟล์ LINE ใช้เป็นข้อมูลสำรองเท่านั้น

ค่าเริ่มต้นใน `code.gs` ถูกเปลี่ยนให้ใช้โฟลเดอร์สองชุดนี้แล้ว หากต้องการกำหนดเองผ่าน Script Properties ให้ใช้:

| Key | ค่า |
|---|---|
| `DRIVE_EQUIPMENT_FOLDER_ID` | `1-gDNrWtUseZas1vtbR-25Ukm_zoR2sOU` |
| `DRIVE_PROFILE_BACKUP_FOLDER_ID` | `1lovhpdL0C24sNSFNOCHFQ8KVnQq1oxAw` |

หลังวาง `code.gs` เวอร์ชันใหม่ใน Apps Script ให้กด Run/Deploy และอนุญาตสิทธิ์ Google Drive ด้วยบัญชีที่เป็นเจ้าของหรือมีสิทธิ์แก้ไขโฟลเดอร์ รูปโปรไฟล์ยังใช้ URL จาก LINE เป็นหลัก ส่วนรูปอุปกรณ์จะถูกย่อก่อนอัปโหลดและแสดงในหน้าอุปกรณ์ หน้างานใหม่ และหน้า LIFF ลูกค้า

> **ความปลอดภัย:** โฟลเดอร์หลักที่ตรวจพบมีสิทธิ์ `Anyone — Writer` อยู่ หากต้องการให้ข้อมูลสำรองรูปโปรไฟล์เป็นส่วนตัว ให้เปลี่ยนการแชร์โฟลเดอร์หลักเป็น `Restricted` ก่อนใช้งานจริง ส่วนรูปอุปกรณ์ให้ระบบเปิดเฉพาะไฟล์เป็น `Anyone with the link — Viewer` เท่าที่จำเป็น
