...
**ต้องอนุญาตสิทธิ์ Drive ครั้งแรก:** ใน Apps Script เลือกฟังก์ชัน `authorizeDriveAccess` จากรายการด้านบน แล้วกด **Run** ขณะล็อกอินด้วยบัญชีเดียวกับที่เลือก `Execute as` จากนั้นกดยอมรับสิทธิ์ Google Drive ให้ครบ หากฟังก์ชันนี้ทำงานสำเร็จจะแสดงชื่อโฟลเดอร์ทั้งสองชุดใน Execution log
...
- เลือกฟังก์ชัน `authorizeDriveAccess` แล้วกด **Run** เพื่อให้ Google ขอสิทธิ์ Drive ใหม่
